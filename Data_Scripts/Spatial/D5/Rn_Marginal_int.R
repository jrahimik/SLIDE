...
################################################################################
Z <- read.table("/ix/djishnu/Javad/SLIDEbench_day5_spatial/z_matrix.csv", sep = ",", header = T, row.names = 1)
y <- read.table("/ix/djishnu/Javad/SLIDEbench_day5_spatial/y.csv", row.names = 1, sep = ",", header = T)
colnames(y) <- "y"
...
saveRDS(df, file                = "/ix/djishnu/Javad/SLIDEbench_day5_spatial/ggplotobject_randompar_data.rds")
saveRDS(P2, file                 = "/ix/djishnu/Javad/SLIDEbench_day5_spatial/ggplotobject_randompar.rds")
ggsave(P2, filename              = "/ix/djishnu/Javad/SLIDEbench_day5_spatial/randomvsPartialPlot_limited.pdf")
ggsave(P2, filename              = "/ix/djishnu/Javad/SLIDEbench_day5_spatial/randomvsPartialPlot_limited.png")
...
ERres <- readRDS("/ix/djishnu/Javad/SLIDEbench_day5_spatial/final_delta_0.063_lambda_1.rds")

...
saveRDS(vaeoadings,"/ix/djishnu/Javad/SLIDEbench_day3_spatial/MOFA_VAE/VAE.rds")
...
saveRDS(factors,"/ix/djishnu/Javad/SLIDEbench_day3_spatial/MOFA_VAE/MOFA_facros_v2.rds")
saveRDS(MofaLoading,"/ix/djishnu/Javad/SLIDEbench_day3_spatial/MOFA_VAE/MOFA_loading_v2.rds")
